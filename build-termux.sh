...
if [ -d revanced-magisk-module ] || [ -f config.toml ]; then
	...
	if git status | grep -q 'is behind\|fatal'; then
		...
		git clone https://github.com/aihara87/Revanced-Extended-magisk-module-android6-7 --recurse --depth 1
		mv -f config.toml revanced-magisk-module/config.toml
		cd revanced-magisk-module
	fi
else
	pr "Cloning revanced-magisk-module."
	git clone https://github.com/aihara87/Revanced-Extended-magisk-module-android6-7 --depth 1
	cd revanced-magisk-module
